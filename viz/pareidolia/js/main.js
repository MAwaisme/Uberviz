...
function init() {
	...
	promptPanel = document.querySelector('#prompt');
	...
	optionMic = document.querySelector('#option-mic');
	optionMic.addEventListener('mousedown', selectOptionMic, false);
	optionSample = document.querySelector('#option-sample');
	optionSample.addEventListener('mousedown', selectOptionSample, false);
